...
parser.add_argument('-ig', '--include_gene', help='does the predictor include the gene annotation in the input? True/False, It has to be similar to training dataset', required=False, default=False)
parser.add_argument('-ir', '--include_repeat', help='does the predictor include the repeat annotation in the input? True/False, It has to be similar to training dataset', required=False, default=False)
